...
public class WordCounter {
    ...
    // calculateWord metodu kelimeleri sayar ve sonuçları Map olarak döndürür
    public static Map<String, Integer> calculateWord() {
        ...
        // Texti kelimelere bölelim
        String[] words = text.split("\\W+");

        // Her kelimeyi sayalım
        for (String word : words) {
            word = word.toLowerCase(); // küçük harfe çevirerek sayımı düzgün yapalım
